...
- :open_file_folder: **Transcription** : directory with the transcription of the 3 zines.
  - DIY_guide.md
  - The_president.md
  - Why_zine.md
 
- :open_file_folder: **XML** : directory with all the 3 encoded tei xml files.
  - DIY_Guide_Prevent_Sexual_Assault.xml
  - The_President_is_Gone.xml
  - Why_Zine_Work.xml
  
- :open_file_folder: **Zine img** : directory with all the pdf of the 3 zines.
  - PRESGONE ONLINE FINAL_2_text.pdf
  - diy-guide-prevent-sexual-assault.pdf
  - why_zine_work.pdf
 
- :open_file_folder: **out** : directory for outputting the relaxng schema
